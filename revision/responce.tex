...
calculated for each of the 131 experimental traces. 
...
\begin{description}
    ...
    \item[$\bullet$] added section S? to discuss in more detail the posteriors of the N=4 experimental results.
\end{description}

...
\underline{\textbf{Response:}} 
We have added references to both Poisson and Gaussian noise when describing the model construction. Further to 
increase clarity we have added a few sentences that describe how we obtain our intensity measurement $x$ from 
the image. 

Changes
\begin{description}
    \item[$\bullet$] Added references to Poisson noise and Gaussian noise
...
As for experiments with varying noise levels, we can think of varying noise in XY-space (or between experiments), 

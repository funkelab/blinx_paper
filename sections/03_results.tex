...
qPAINT is based on an accurate measure of the average dark time between blinking events. 
	...
	% 
	This regime presents a challenge to \ours (\figref{fig:results:campare_kinetics}a $\poff >> \pon$). 
	%
	...
	(\figref{fig:results:qpaint_counting}c) to a level comparable to the 
	favorable kinetic regime (\figref{fig:results:sim_counting}a).

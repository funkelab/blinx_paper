...
which allows fine control over the number of emitters, was used.
	...
	collect traces for counting with \ours (\figref{fig:results:experimental}a,b).
	%
...
estimated count was 3 (1/131) (\figref{fig:results:experimental}e).
	%
	...
	the incorrect counts were due to low trace SNR. % quantify this??

...
a probabilistic count may be preferable for downstream analysis.
  ...
  Bayesian approaches can estimate a likelihood for each possible condition 
  and have previously been applied to estimate physical parameters from fluorescence 
  intensity time traces \citep{hon_bayesian-estimated_2019, bronson_learning_2009, 
  garry_bayesian_2020}. 

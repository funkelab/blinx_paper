\begin{abstract}
  ...
  can be observed.
  %
  This problem occurs regularly in light microscopy of \objects 
  ...
  differentiable \hmm, 
  estimating a posterior distribution of the total number of emitters.
  %
  % Given a trace of intensity, our model jointly estimates the
  ...
  % emitters.
  %
  We show that our model is more accurate and increases the range of 
  countable subunits by a factor of two compared to current state-of-the-art methods.
  %
  Furthermore, we demonstrate that our model can be used to investigate the
  effect of blinking kinetics on counting ability, and therefore can inform optimal 

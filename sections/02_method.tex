...
\cite{pawely_three-dimensional,huang_video-rate_2013, laine_imaging_2021}.
  %
  \revise{Here we determine x by summing the intensity values of a square, larger than the point spread function, centered at the detected spot,
  ...
  % spread function to capture the majority of photons emitted by the spot.
  }
  %

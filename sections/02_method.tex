...
\end{equation*}
In fact, because the sum of \pchain_{t} over all \y{t} is one by definition, the measurement likelihood is equivalent to the product of all normalization factors:
\begin{align*}
  p(\trace|\n,\parameters)

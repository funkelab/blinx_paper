...
We then use maximum likelihood estimation to find the \parameters that best fit the observation \trace, given \n. 
Finally this process is repeated for all possible values of n, and maximum likelihood estimation used to find the estimated number of emitters in the system \estimatedn:

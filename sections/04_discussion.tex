...
compute than \lbfcs or qPAINT (see \secref{runtime}).}
  %
  However, neither of these are fatal, and specific implementation details 
...
predictable blinking behavior \revise{(see \secref{dna-paint-concerns})}.
  %

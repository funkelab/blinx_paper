\begin{figure*}[t]
  ...
  \caption{
      ...
      %
      \panelref{c} The distribution of observed intensities is affected by both Poisson distributed shot noise (\parameterse), and 
        Gaussian distributed readout noise (\parametersc).
      %
      \panelref{d} \ours is based on a hidden Markov model conditioned on the total count $n$ and seven estimated parameters.
  }

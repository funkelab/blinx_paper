\begin{figure*}
  ...
  \begin{panel}{(a)}{0.58\textwidth}
    ...
    \setlength\plotheight{80mm}
    \tikzsetnextfilename{figure_3_kinetics_sim_sweep}
  ...
  \begin{panel}{(b)}{0.42\textwidth}
    ...
    \tikzsetnextfilename{figure_3_kinetics_experiments}
  ...
  \begin{panel}{(c)}{\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node[anchor=south east,text width=12mm]
        at ($(fancyplot.south east)+(-0.4,1.4)$)

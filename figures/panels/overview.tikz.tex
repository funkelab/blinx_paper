...
\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \argsinput[
      tracecsv=figures/data/overview/trace.csv,
  ...
  \begin{scope}
    ...
    \pgfplotsset{
      every axis/.style={yshift=-8mm,anchor=north,name=posterior,at=(mle)},
      xtick distance=1
    }
    \argsinput[
      posteriorcsv=figures/data/overview/posterior.csv,
      posteriorcol=posterior
    ]{figures/plots/p_n_given_x.plot}
    \node[below=2mm of posterior.north] {posterior};
  \end{scope}

...
\definecolor{funkey_color_16}{HTML}{FFFFFF} % white
\definecolor{funkey_color_17}{HTML}{000000} % black


% colors for this paper
\colorlet{tracecolor}{funkey_color_1}
\colorlet{ztracecolor}{funkey_color_2}
\colorlet{intensitymodelcolor}{funkey_color_2}
\colorlet{posteriorcolor}{funkey_color_4}
\colorlet{parametercolor}{gray!20!white}
